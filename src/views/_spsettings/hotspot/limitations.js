...
import limitationService from "../../../services/settings/limitations.service";

import bandwidthCodes from "../../../data/_settings/bandwitdh";
import trafficCodes from "../../../data/_settings/traffic";
import periodCodes from "../../../data/_settings/period";
import sessionCodes from "../../../data/_settings/session";
...
function LimitationTable() {
  ...
  const [alertMsg, setAlertMsg] = useState({
    ...
    text: "text-danger",
    icon: "fas fa-ban",
    msg: "An error occured while trying to request limitations.",
  });
  ...
  const getErrorMessage = (err) => {
    ...
    switch (err) {
      ...
      default:
        alertMsg.msg =
          "An error occured while trying to request limitation.";
        break;
    }
